...
review and explicit append. Upload UI, import-session persistence, workers, provider integrations,
tax, mobile, AI, and Stage 3.10 implementation remain out of scope.
