...
deterministic snapshot rebuilds. Stage 3.8 planning is closed; Stage 3.8 implementation is active
on a feature branch and is limited to the internal import review → append flow integration. Public
import API, upload UI, import-session persistence, workers, provider integrations, tax, mobile, and
