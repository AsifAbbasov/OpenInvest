...
deterministic snapshot rebuilds. Public import API, upload UI, import-session persistence, workers,
provider integrations, tax, mobile, and AI remain out of scope.
