...
Stage 3.7 planning is closed; Stage 3.7 implementation is active on a feature branch and is limited
to internal atomic append of user-approved import rows.
