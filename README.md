...
Stage 3.18 contract/security proposal are closed through PRs #46 and #47. Stage 3.19 is the active
documentation-only privacy security/ADR proposal for the remaining deletion/anonymization/
backup-retention blocker; it does not authorize an implementation stage.
