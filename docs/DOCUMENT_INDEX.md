...
| Stage 3.75 Portfolio Cash Flow & Income Truth | Implementation candidate: effective-ledger cash/income projection, additive API, manual income/expense UX and summary truth | `stages/STAGE_03_75_PORTFOLIO_CASH_FLOW_INCOME_IMPLEMENTATION.md` |
