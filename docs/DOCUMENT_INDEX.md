...
| --- | --- | --- | --- | --- |
| SOT-001 | Source of Truth | 1.4.19 | Approved | `SOURCE_OF_TRUTH.md` |
...
| Stage 3.9 import API boundary slice | Active / implementation PR | `stages/STAGE_03_09_IMPORT_API_BOUNDARY_SLICE.md` |
