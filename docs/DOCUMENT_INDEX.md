...
| --- | --- | --- | --- | --- |
| SOT-001 | Source of Truth | 1.4.37 | Approved | `SOURCE_OF_TRUTH.md` |
...
| Stage 3.15 Web asset discovery UI slice | Active / implementation | `stages/STAGE_03_15_WEB_ASSET_DISCOVERY_UI_SLICE.md` |
