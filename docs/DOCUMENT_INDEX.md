...
| --- | --- | --- | --- | --- |
| SOT-001 | Source of Truth | 1.4.41 | Approved | `SOURCE_OF_TRUTH.md` |
...
| Document | Status | Location |
| --- | --- | --- |
| Stage 3 plan | Active / staged implementation; updated through Stage 3.16 repository audit fixes | `stages/STAGE_03_FIRST_VERTICAL_SLICE.md` |
...
| Stage 3.16 repository audit fixes | Active / audit fixes | `stages/STAGE_03_16_REPOSITORY_AUDIT_FIXES.md` |
