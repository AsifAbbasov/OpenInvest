...
| --- | --- | --- | --- | --- |
| SOT-001 | Source of Truth | 1.4.26 | Approved | `SOURCE_OF_TRUTH.md` |
...
| Stage 3.12 Web authentication UI planning | Draft / planning active | `stages/STAGE_03_12_AUTH_UI_PLANNING.md` |
