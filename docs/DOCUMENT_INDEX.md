...
| --- | --- | --- | --- | --- |
| SOT-001 | Source of Truth | 1.4.33 | Approved | `SOURCE_OF_TRUTH.md` |
...
| Stage 3.14 asset search/card API boundary planning | Draft / active | `stages/STAGE_03_14_ASSET_API_BOUNDARY_PLANNING.md` |
