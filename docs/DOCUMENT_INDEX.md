...
| --- | --- | --- | --- | --- |
| SOT-001 | Source of Truth | 1.4.49 | Approved | `SOURCE_OF_TRUTH.md` |
...
| Document | Status | Location |
| --- | --- | --- |
| Stage 3 plan | Closed through Stage 3.21 proposal; Stage 3.22 key-custody proposal is active without implementation authorization | `stages/STAGE_03_FIRST_VERTICAL_SLICE.md` |
...
| Stage 3.22 privacy key-custody and destruction-proof proposal | Active / proposal only | `stages/STAGE_03_22_PRIVACY_KEY_CUSTODY_PROPOSAL.md` |
