...
| --- | --- | --- | --- | --- |
| SOT-001 | Source of Truth | 1.4.45 | Approved | `SOURCE_OF_TRUTH.md` |
...
| Document | Status | Location |
| --- | --- | --- |
| Stage 3 plan | Closed through Stage 3.18 proposal; Stage 3.19 security/ADR proposal is active without implementation authorization | `stages/STAGE_03_FIRST_VERTICAL_SLICE.md` |
...
| Stage 3.19 privacy security and ADR proposal | Active / proposal only | `stages/STAGE_03_19_PRIVACY_SECURITY_ADR_PROPOSAL.md` |
