...
| --- | --- | --- | --- | --- |
| SOT-001 | Source of Truth | 1.4.16 | Approved | `SOURCE_OF_TRUTH.md` |
...
| Stage 3.8 import review append flow slice | Active / implementation PR | `stages/STAGE_03_08_IMPORT_REVIEW_APPEND_FLOW_SLICE.md` |
