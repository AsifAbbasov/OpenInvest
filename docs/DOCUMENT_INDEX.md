...
| --- | --- | --- | --- | --- |
| SOT-001 | Source of Truth | 1.4.36 | Approved | `SOURCE_OF_TRUTH.md` |
...
| Stage 3.15 Web asset discovery UI planning | Active / planning | `stages/STAGE_03_15_WEB_ASSET_DISCOVERY_UI_PLANNING.md` |
