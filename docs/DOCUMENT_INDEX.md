...
| --- | --- | --- | --- | --- |
| SOT-001 | Source of Truth | 1.4.28 | Approved | `SOURCE_OF_TRUTH.md` |
...
| Stage 3.12 Web authentication UI slice | Active / implementation | `stages/STAGE_03_12_AUTH_UI_SLICE.md` |
