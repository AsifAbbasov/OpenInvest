...
| 3.25 — Privacy Security Review evidence-collection plan | Define minimized, integrity-protected, independently verified evidence collection before formal Security Review | Complete / merged through PR #54 |
| 3.26 — Privacy Security Review restricted-access evidence intake | Define the named-owner, restricted-access, minimized evidence-intake boundary before any source inspection | Active / intake authorization only |
