...
| 3.75 — Portfolio Cash Flow & Income Truth | Reuse Stage 3.74 effective ledger for backend-owned cash/income totals, monthly aggregation, manual income/expense entry and truthful summary cash/income | Implementation candidate; canonical only after reviewed protected merge; zero-budget, no provider/migration/cache-table |
