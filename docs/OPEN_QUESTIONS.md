...
None. Stage 3.75 — Portfolio Cash Flow & Income Truth is complete and canonical through PR #153 squash merge `57faae841805a5ab11ac959018a315cbada69207` from exact evidence head `fae674518e37d11cad0da28d91682c35bf8bf99a`. It introduces no unresolved architecture question: it reuses the Stage 3.74 effective ledger, adds a bounded backend-owned cash-flow/income aggregate and additive API, keeps financial arithmetic out of the browser, introduces no market provider, migration or cache table, and does not attribute unrelated expenses to `netInvestmentIncome`. Implementation-head CI #459 / run `34155729975` and evidence-head CI #460 / run `34156290105` both completed 10/10 SUCCESS, with fresh External and no-drift verification `APPROVED`. Any future Stage 3.76+ provider/valuation, broader cost-basis/tax-lot semantics, imported SELL expansion or privacy-lifecycle implementation must enter this register if it changes frozen architecture.
