...
**Current Portfolio Position / Cost Basis lifecycle: Stage 3.70 / ADR-009 is accepted and canonical through PR #137 squash merge `b772e52221fbb694b3116bd1b579db99d4e56302`; Stage 3.71 runtime is canonical through PR #138 squash merge `827f49f909ace5a3f7bcb2a3f51ce7c638c458ad`, final evidence head `6f66f7f3da982b2f83637452bfd1f556b92b3956`, CI #382 / run `34028563925` 10/10 SUCCESS. Manual SELL, deterministic portfolio-local ledger sequence/replay, authoritative WAC/acquisition-basis snapshots and atomic oversell rollback remain active Stage 3.71 semantics. Stage 3.71 lifecycle/documentation closure is COMPLETE through PR #140 squash merge `97c35a7b0fe7e2cd487c63d03b8ba79f80dcfc7b`; `STAGE-03-71-GOV-01` remains dispositioned with historical noncompliance preserved. `STAGE-03-72-GOV-01` is dispositioned through PR #143 squash merge `be654b938484d4ef4e4796b247bb04bf7efd2049`, protected tree `d90ad717da04c7a28f538a4a0fea2781409dd44e`; historical noncompliance is permanently preserved and residual governance risk accepted. The effective disposition/closure does not itself make Stage 3.72 planning canonical or authorize planning acceptance/Ready/merge. No Stage 3.72 runtime implementation or later product scope, market provider, market valuation, XIRR/returns, imported SELL, correction/reversal, tax basis, bond NKD, provider activation, production rollout, notifications or AI are authorized. Stage 3.72 planning is a separate merge-activated gate defined by `docs/stages/STAGE_03_72_PORTFOLIO_POSITION_PROJECTION_PLANNING.md`; planning activation alone grants no Stage 3.72 runtime implementation, provider, production-rollout, or later-stage authorization.**
