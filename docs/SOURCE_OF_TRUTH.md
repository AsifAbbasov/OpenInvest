...
**Documentation registry baseline: the numbered Stage 3 product/runtime frontier remains Stage 3.77, canonical through PR #157 squash merge `63d916b447e91c4de54efee5c66b27cf7727be92`. Separately governed Corporate Actions Feature 3D implementation is merged through PR #164 / squash `247081a95a7daf33c0077c88c5f41cb2e8161865` from final evidence head `ddc5b5be36f0b5ae127c6ee430918a9dba1b453e`, merged tree `ec7bc9152210913b1a6ef742bddd599abee50bc7`; implementation CI #499 and evidence-head CI #501 each completed all 10 required checks successfully, final Internal and fresh External reviews were `APPROVED`, and no-semantic-drift verification was `APPROVED`. This post-merge documentation closure synchronizes the active registries for Feature 3D while preserving runtime activation as a separate decision.**
**Numbered implementation frontier: Stage 3.77 — Portfolio Money-Weighted Return / XIRR is COMPLETE / CANONICAL through PR #157 squash merge `63d916b447e91c4de54efee5c66b27cf7727be92`. It adds backend-owned money-weighted return using Stage 3.74 correction/reversal-aware external DEPOSIT/WITHDRAWAL flows, exact-date Stage 3.76 COMPLETE `USER_SUPPLIED` RUB terminal valuation, ACT/365, Decimal scale-8 / Half-Even public output, one canonical engine for `/returns` and `PortfolioSummary.xirr`, explicit unavailable reasons, multiple-root detection and fail-closed numerical boundaries. BUY/SELL/DIVIDEND/COUPON/FEE/TAX remain internal flows, and TWR, nominal/real/inflation return activation, FX, provider/live/MOEX prices, broker sync, tax, workers, notifications, AI and mobile remain outside this stage. Stage 3.77 remains the last numbered product/runtime stage; Stage 3.78+ requires a separately reviewed gate.**
**Separately governed Feature 3D implementation: COMPLETE / MERGED through PR #164 / squash `247081a95a7daf33c0077c88c5f41cb2e8161865` for exact registry mode `TINVEST_CORPORATE_ACTIONS_CONSTRAINED`. Only `GetDividends` → canonical `DIVIDEND` and `GetBondCoupons` → canonical `COUPON` are implemented, using the reviewed static instrument map and provider-neutral Corporate Actions boundary. Source/use rights remain `CONDITIONAL-GO` only for that exact mode. Runtime activation = NO; live T-Invest token = NOT USED in implementation/review; production T-Invest traffic authorized/claimed by Feature 3D = NO; provider persistence/cache/polling = NO; provider events do not mutate ledger truth.**
...
**Current Corporate Actions lifecycle: Stage 3.61 planning and Stages 3.62/3.63/3.64 Features 3A/3B/3C are protected-merged through PRs #125/#126/#127/#128; Stage 3.65 documentation closure is canonical through PR #129 / merge `1c30a4bf637c933e7c210cff6e26fabd91d8bab1`; Stage 3.66 request-cancellation hardening is protected-merged through PR #130 / merge `7564dbbda9133f0b8965f9e7d0a0c0b81b82e992`, tree `b525f0960cb2613f62eaa9583d6394759a1cdd3b`; Stage 3.67 closure is canonical through PR #131 / merge `c885f6e57ea08e4583103fe2f22f142bf13a8560`, tree `53f823e92b02721211e1d89f8af6374fffc252ae`; provider-neutral boundary, Calendar/Heatmap projection, API/UI, stale-result protection and component-unmount/replacement cancellation are implemented and documentation-closed. Feature 3D now adds the separately governed constrained T-Invest adapter implementation through PR #164 / squash `247081a95a7daf33c0077c88c5f41cb2e8161865` under `TINVEST_CORPORATE_ACTIONS_CONSTRAINED`; implementation is complete, while runtime activation remains NO, no live token was used, production provider traffic remains not authorized/claimed by this feature, and any broader T-Invest method/source-use scope requires a new review.**
...
remains separate and is not superseded.
...
`be774b3a8423ffba98633b257983856b2c990b95`, with form blob `8968fc9c5a91ba9d314c5f1fb29368793d6c6f61`, focused-test blob `12df8f19344829772f7eea3412edd33e131257bc` and CI #306 / run
`33499393962` at 10/10 SUCCESS.

The Stage 3.50 evidence lifecycle remains historically noncompliant. P2-GOV-01 is now dispositioned,
...
## Stage 3.59–3.69 market-data, Corporate Actions, and Dividend Calculator lifecycle
...
`4ba610c1d20c95f10a5a16a6a0ece6caceb3236e`; Corporate Actions architecture/API/UI implementation debt is
...
`53f823e92b02721211e1d89f8af6374fffc252ae`. The previously carried component-unmount cancellation P3 and the
Stage 3.66 lifecycle/documentation debt are CLOSED.

Stage 3.68 Dividend Calculator is canonical through PR #133 squash merge
