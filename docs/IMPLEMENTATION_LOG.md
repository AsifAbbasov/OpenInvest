...
| 3 — First Vertical Slice | Implement the first thin MVP path after contract and Web baseline approval | Implementation closed through Stage 3.16 audit-fix closure; Stage 3.17-3.24 proposals are merged; Stage 3.25 privacy evidence planning remains separate; Stage 3.27 implementation is merged and closure governance is in PR #58 | [Stage 3 plan](stages/STAGE_03_FIRST_VERTICAL_SLICE.md) |
...
| 3.27 — Import Financial Identity and Cash-Flow Semantics Remediation | Remediate repository-audit P1-02/P1-03/P1-04 across import identity, reconciliation, cash-flow semantics, PostgreSQL, and OpenAPI | Implementation complete / merged through PR #55 at `6e8c806de857f844954f1db513487357dfe90187`; closure governance candidate is PR #58 | [Stage 3.27 report](stages/STAGE_03_27_IMPORT_FINANCIAL_IDENTITY_REMEDIATION.md) |
...
- PR #58 records closure governance and becomes canonical only after its own
  required gates and squash merge.
