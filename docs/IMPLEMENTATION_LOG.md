...
- Stage 3.76 does not authorize XIRR/TWR/real-return methodology, inflation, FX, tax advice/export, broker synchronization, Redis/Kafka/workers, notifications, AI, mobile, redesign, or Stage 3.77+ scope.
