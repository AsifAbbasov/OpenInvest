...
| Product risk refinement | Convert hard PRD criticism into controlled MVP risk decisions | In progress | [MVP product risk refinement](product/MVP_PRODUCT_RISK_REFINEMENT.md) |
