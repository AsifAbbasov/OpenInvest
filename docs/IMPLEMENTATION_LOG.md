...
| 3.3 — Next.js Presentation Slice | Render the first Web path through the Go API only | In progress | [Stage 3.3 report](stages/STAGE_03_03_NEXTJS_PRESENTATION_SLICE.md) |
